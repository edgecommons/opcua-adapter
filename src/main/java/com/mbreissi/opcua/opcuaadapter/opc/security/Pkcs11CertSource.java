 ...
 * (the same mechanism the ggcommons {@code Pkcs11KeyProvider} uses for KEK wrapping).
 *
 * <p>Net-new vs the ggcommons credentials subsystem (which exposes no signing key) and untested
...
public final class Pkcs11CertSource implements CertSource {
    ...
    public ClientIdentity load() throws Exception {
        String config = "--name=ggcommons-opcua\nlibrary=" + modulePath + "\nslotListIndex=" + slotIndex + "\n";
